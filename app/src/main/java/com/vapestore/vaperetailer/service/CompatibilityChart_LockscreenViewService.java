 ...
 */
public class CompatibilityChart_LockscreenViewService extends Service {
...
//        sIsSoftKeyEnable = SharedPreferencesUtil.get(Lockscreen.ISSOFTKEY);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        return CompatibilityChart_LockscreenViewService.START_NOT_STICKY;
    }
    ...
    private void initView() {
        ...
        if (null == mLockscreenView) {
            mLockscreenView = mInflater.inflate(R.layout.activity_compatibility_chart, null);
    ...
    private void settingLockView() {
        ...
        chartimage = (ImageView) mLockscreenView.findViewById(R.id.imvVaping);
        ...
        sendemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Lockscreen.getInstance(getApplicationContext()).startLockscreenService("SendToEmail", "compatibility", imageId);
        ...
        sendphone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferencesUtil.setBoolean(Lockscreen.ISLOCK, true);
                Lockscreen.getInstance(getApplicationContext()).startLockscreenService("SendToPhone", "compatibility", imageId);
...
//                dettachLockScreenView();
//                CompatibilityChartActivity comtabilityActivity = new CompatibilityChartActivity();
//                comtabilityActivity.finish();
                Intent stopLockscreenViewIntent = new Intent(mContext, CompatibilityChart_LockscreenViewService.class);
