 ...
 */
public class SubProductDetail_LockScreenService extends Service {
        ...
        public void onReceive(Context context, Intent intent) {
            if (null != context) {
                if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
                    Intent startLockscreenIntent = new Intent(mContext, SubProductDetail_LockScreenViewService.class);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        return SubProductDetail_LockScreenService.START_STICKY;
    }
